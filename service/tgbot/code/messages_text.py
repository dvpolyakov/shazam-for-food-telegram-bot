...
CHALLENGE_MESSAGE = "Сможешь ли прислать мне такую еду, которую я не смогу определить?)"
...
REACTION_RESULT_BAD_REACTION = "Хорошо, понял. Пришлите, пожалуйста, вашу фотографию моему создателю @dpolyak, он постарается учесть ваш кейс"
